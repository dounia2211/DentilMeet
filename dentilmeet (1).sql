...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 27 avr. 2026 à 01:56
...
--
-- Structure de la table `anamnesis`
--
...
INSERT INTO `appointment` (`id_appointment`, `appointment_date`, `appointment_time`, `appointment_status`, `reason`, `service_type`, `total_price`, `deposit_amount`, `id_patient`, `id_dentist`, `id_plan`) VALUES
(1, '0000-00-00', '12:30:00', 'confirme', NULL, NULL, 0.00, 0.00, 5, 1, NULL);
...
INSERT INTO `chat_message` (`id_message`, `message_text`, `sent_at`, `is_read`, `sender_type`, `sender_id`, `receiver_id`, `id_appointment`) VALUES
(2, 'Bonjour!', '2026-04-08 19:48:48', 0, 'patient', 5, 1, 1),
(3, 'Bonjour!', '2026-04-08 19:52:49', 0, 'patient', 5, 1, 1),
(4, 'Bonjour', '2026-04-08 19:58:34', 0, 'patient', 5, 1, 1),
(5, 'Bonjour', '2026-04-08 20:07:13', 0, 'patient', 5, 1, 1);
...
--
-- Déchargement des données de la table `clinic`
--

INSERT INTO `clinic` (`id_clinic`, `name`, `address`, `city`, `phone`) VALUES
(1, 'Smile Dental', 'Oran Centre', '', NULL),
(2, 'Smile Dental', 'Oran Centre', '', NULL),
(3, 'Smile Dental', 'Oran Centre', '', NULL);
...
CREATE TABLE `dentist` (
  ...
  `clinic_status` enum('Available','Busy','Offline') NOT NULL DEFAULT 'Available'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Déchargement des données de la table `dentist`
--

INSERT INTO `dentist` (`id_dentist`, `full_name`, `email`, `password`, `speciality`, `photo`, `phone`, `year_of_experience`, `description`, `created_at`, `diploma_document`, `license_number`, `verification_status`, `submitted_at`, `is_suspended`, `validated_by`, `id_clinic`, `clinic_status`) VALUES
(1, 'bouras ', 'bouras123@gmail.com', 'bouras123', 'Oral Surgeon', NULL, '0777777777', 0, NULL, '2026-04-08 14:48:41', '', '', 'approuve', NULL, 0, NULL, NULL, 'Available'),
(3, 'Ahmed Bouras', 'ahmed@test.com', '$2y$12$KqcRBGWw2iW7ZnlGbUfUrO6DnJmZSvUozeeuYFkOq41hmom5S/8jO', 'Oral Surgeon', NULL, '0555555555', 0, NULL, '2026-04-26 15:00:22', 'uploads/diplomas/doc_69ee0c665bb088.30103068.png', 'DEN2024001', '', NULL, 0, NULL, 3, 'Available');
...
CREATE TABLE `notification` (
  ...
  `type` enum('rappel','confirmation','annulation','alerte','reschedule') NOT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `is_read` tinyint(1) NOT NULL DEFAULT 0,
  `id_patient` int(11) DEFAULT NULL,
  `id_dentist` int(11) DEFAULT NULL
...
INSERT INTO `patient` (`id_patient`, `full_name`, `email`, `password`, `phone`, `birth_date`, `address`, `created_at`, `is_suspended`, `photo`, `gender`) VALUES
(1, 'Youcef Benali', 'youcef@gmail.com', '$2y$12$03QaqzIPoNTlXuYJWNxz6.tjDctRcYcJYc1Z/LE46enrK8vAzROhW', '0555123456', NULL, NULL, '2026-04-08 12:29:25', 0, NULL, NULL),
(3, 'Youcef Benali', 'dounia@gmail.com', '$2y$12$2k2le5ppqNibirWfNk6y4uQLFz7OAY0VZwG0Jf3oPPTtot6tmtji2', '0555123434', NULL, NULL, '2026-04-08 12:33:28', 0, NULL, NULL),
(5, 'test user', 'test@email.com', '$2y$12$PtN3YyaqlCNB21dVC1a5Ku7NO9aTDivi0wyAeEoX2MxWXBcDbuCou', '0555623456', NULL, NULL, '2026-04-08 14:40:33', 0, NULL, NULL);
...
INSERT INTO `payment` (`id_payment`, `method_payment`, `payment_status`, `transaction_reference`, `invoice_number`, `invoice_date`, `invoice_path`, `amount`, `paid_at`, `id_appointment`) VALUES
(1, 'carte', 'paye', 'TXN-8A86BC281089B570', NULL, NULL, NULL, 2500.00, '2026-04-08 20:11:06', 1);
...
--
-- Index pour la table `anamnesis`
--
ALTER TABLE `anamnesis`
  ADD PRIMARY KEY (`id_anamnesis`),
  ADD UNIQUE KEY `uk_patient_dentist` (`id_patient`,`id_dentist`),
...
--
-- AUTO_INCREMENT pour la table `anamnesis`
--
ALTER TABLE `anamnesis`
...
--
ALTER TABLE `clinic`
  MODIFY `id_clinic` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `dentist`
--
ALTER TABLE `dentist`
  MODIFY `id_dentist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Contraintes pour la table `anamnesis`
--
ALTER TABLE `anamnesis`
  ADD CONSTRAINT `anamnesis_ibfk_1` FOREIGN KEY (`id_patient`) REFERENCES `patient` (`id_patient`),
  ADD CONSTRAINT `anamnesis_ibfk_2` FOREIGN KEY (`id_dentist`) REFERENCES `dentist` (`id_dentist`);
