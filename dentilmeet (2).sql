...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 10 avr. 2026 à 11:59
...
INSERT INTO `dentist` (`id_dentist`, `full_name`, `email`, `password`, `speciality`, `photo`, `phone`, `year_of_experience`, `description`, `created_at`, `diploma_document`, `license_number`, `verification_status`, `submitted_at`, `is_suspended`, `validated_by`, `id_clinic`) VALUES
(1, 'bouras ', 'bouras123@gmail.com', 'bouras123', 'Oral Surgeon', NULL, '0777777777', 0, NULL, '2026-04-08 14:48:41', '', '', 'approuve', NULL, 0, NULL, NULL);
...
(5, 'test user', 'test@email.com', '$2y$12$PtN3YyaqlCNB21dVC1a5Ku7NO9aTDivi0wyAeEoX2MxWXBcDbuCou', '0555623456', NULL, NULL, '2026-04-08 14:40:33', 0, NULL);
...
--
ALTER TABLE `dentist`
  MODIFY `id_dentist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
